...
The system operates almost only into an **additive-only regime**, it does not reconstruct, rebalance or correct the stereo image, it introduces a secondary spatial layer derived from local signal properties.
